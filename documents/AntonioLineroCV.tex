...
\cvitem{}{
  ...
  Revision invited at \emph{Biometrics}. 
}

\cvitem{}{
  Du, J. and \textbf{Linero A.R.}, (2018+)
...
\cvitem{}{\textbf{Linero, A.R.} and Yang, Y. (2018+) Bayesian Regression Tree Ensembles that Adapt to Smoothness and Sparsity. \emph{Journal of the Royal Statistical Society, Series B.} To appear.}

\cvitem{}{\textbf{Linero, A.R.} and Bradley, J.R (2018+) Multi-rubric Models for

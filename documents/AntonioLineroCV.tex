...
% \begin{enumerate}
% \item Du, J.$^{\star}$ and \textbf{Linero A.R.}, (2019) Incorporating Grouping Information into Bayesian Decision Tree Ensembles. To appear in \emph{Proceedings of the 36th International Conference on Machine Learning (ICML)}. 
% \end{enumerate}

\cvitem{\docounter}{ Du, J.$^{\star}$ and \textbf{Linero A.R.}, (2019) Incorporating Grouping Information into Bayesian Decision Tree Ensembles. To appear in \emph{Proceedings of the 36th International Conference on Machine Learning (ICML)}. }

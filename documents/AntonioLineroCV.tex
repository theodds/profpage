...
\cvitem{2016--2018}{\emph{Functional Analysis Tools (FATs)} (Co-PI). Funded by
  Department of Defense (SOT-FSU-FATs-16-06). Total award \$327,000.}{}
...
\cvitem{}{\textbf{Linero, A.R.} and Yang, Y. (2017) Bayesian Regression Tree Ensembles that Adapt to Smoothness and Sparsity. Submitted.}

\cvitem{}{\textbf{Linero, A.R.} and Bradley, J.R (2017) Multi-rubric Models for
  Ordinal Spatial Data with Application to Online Ratings. Major revision requested at \emph{Annals of Applied Statistics.}}



\section{Publications in press}

\cvitem{}{\textbf{Linero, A.R.} (2017) A Review of Tree-Based Bayesian Methods. \emph{Communications for Statistical Applications and Methods.} To appear.}


\cvitem{}{\textbf{Linero, A.R.} and Daniels, M.J. (2017)  Bayesian Approaches for Missing Not at Random Outcome Data: The Role of Identifying Restrictions.
...
\cvitem{}{\textbf{Linero, A.R.} (2016) Bayesian regression trees for high
...
\cventry{2017}{Joint Statistical Meeting}
...
\cvitem{\textbf{STA4442}}{Introduction to Probability. Fall 2015, Spring 2017, Spring 2018}
\cvitem{\textbf{STA5168}}{Statistics in Applications 3. Fall 2016, Fall 2017}
